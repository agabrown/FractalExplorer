...
/**
 * Class of enum type that can be used to apply a certain scaling to image data (in vector or array
 * form). The data are scaled to the range [0,1] in various ways.
 * 
 * <pre>
...
public enum ImageScaling {
  ...
  /**
   * Scale the data by first taking the square root of the values (and properly account for negative
   * data values).
   */
  ...
  /**
   * Scale the data by first taking the base-10 logarithm of the values (and properly account for
  ...
  /**
   * Provide a scaling method for a double[] array. Scale the data to the interval [0,1] for use
   * with the ColourtTable class
   */
   ...
   * @param dataVec
   *          The data vector.
   * @return Two-element array containing minimum and maximum as the first and second entry,
   *         respectively.
   */
