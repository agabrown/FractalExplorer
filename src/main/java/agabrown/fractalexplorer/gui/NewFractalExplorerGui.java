...
public final class NewFractalExplorerGui extends JFrame implements KeyListener, MouseListener, PropertyChangeListener {
     ...
     */
    ImageViewingPanel getViewPanel() {
        return viewingPanel;
    }
     ...
     */
    FractalGenerator getFractalSet() {
        return fractalSet;
    }
     ...
     */
    ComplexPlaneView getComplexPlaneView() {
     ...
     *
     * @param cpv New complex plane view data.
     */
    void setComplexPlaneView(final ComplexPlaneView cpv) {
        ...
        switch (e.getKeyCode()) {
            ...
            case KeyEvent.VK_J:
                ...
                if (showJuliaSet) {
                     ...
                     */
                    ComplexDynamicsBased julia = FractalGeneratorFactory.getJuliaClassicEscapeTime(Complex.valueOf(activeCpv.getCentreReal(),
