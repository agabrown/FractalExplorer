...
public final class ImageViewingPanel extends JPanel {
     ...
     *
     * @param imArr  Image of the fractal set.
     ...
     *
     * @param imScaling Scaling to be applied before colouring the image.
     */
    ...
    /**
     * Set whether the colour scale should be reversed.
     *
     * @param rev If true reverse the colour scale.
     */
