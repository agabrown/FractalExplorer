...
public final class ComplexPlaneView {
   ...
   * 
   * @param sizeRePix
   *          Size of real axis in pixels.
   * @param sizeImPix
   *          Size of imaginary axis in pixels.
   */
   ...
   * 
   * @param centreRe
   *          New centre along real axis.
   * @param centreIm
   *          New centre along imaginary axis.
   */
   ...
   * 
   * @param i
   *          Pixel position along real axis.
   ...
   * 
   * @param x
   *          Pixel coordinate along real axis.
   * @return Value of the coordinate along the real axis.
   */
